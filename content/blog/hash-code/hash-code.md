...
{% image "./properties-backing-store-empty.png",  "a graph" %}
...
{% image "./properties-backing-store-array.png", "a graph" %}
...
{% image "./properties-backing-store-dictionary.png", "a graph" %}
